 ...
 * context状态通知
*/
void UkmediaControlWidget::on_context_state_notify (MateMixerContext *context,GParamSpec *pspec,UkmediaControlWidget *w)
{
...
/*
    连接context，处理不同信号
*/
void UkmediaControlWidget::set_context(UkmediaControlWidget *w,MateMixerContext *context)
{
