...
public:
    ...
    static void set_context(UkmediaControlWidget *w,MateMixerContext *context);
    static void on_context_state_notify (MateMixerContext *context,GParamSpec *pspec,UkmediaControlWidget *w);
